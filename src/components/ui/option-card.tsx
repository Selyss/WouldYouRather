...
export function OptionCard({ 
  ...
  return (
    <Card
      className={`group relative p-12 bg-slate-800 border-2 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl min-h-[320px] flex flex-col items-center justify-center ${isHighlighted
    ...
    >
      <div className="text-center">
        <div className="flex flex-col items-center">
          <div className={`w-16 h-16 bg-gradient-to-br ${gradientFrom} ${gradientTo} rounded-full flex items-center justify-center transition-transform mb-8 ${isHighlighted ? "scale-110" : "group-hover:scale-110"
            }`}>
