...
export function AppSidebar({ session }: AppSidebarProps) {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside
        className={`hidden md:block fixed left-0 top-0 h-full bg-slate-800/90 backdrop-blur-sm border-r border-slate-700 transition-all duration-300 ease-in-out z-40 ${
